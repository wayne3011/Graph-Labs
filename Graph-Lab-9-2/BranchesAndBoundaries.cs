    ...
    internal class BranchesAndBoundaries
    {
        ...
        public Edge[] Run()
        {
            ...
            while (true)
            {
                ...
                SelectedOption.phi = ParentNode.phi + SelectedOption.CurrentAdjacecnyMatrix.RowReduce() + SelectedOption.CurrentAdjacecnyMatrix.ColumnReduce();
                ...
                NotSelectedOption.phi = ParentNode.phi + option.weight;
        ...
        private bool Search(List<Edge> path,TreeNode currentNode)
        {
            ...
            if(Search(path, currentNode.SelectOption) || Search(path, currentNode.NoSelectOption)) { if(currentNode.select != false) path.Add(currentNode.CurrentEdge); return true; }
            return false;
        }
    }
}
